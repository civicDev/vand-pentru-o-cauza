...
class ControllerSellerseller extends Controller
{
    ...
    protected function getList()
    {
        ...
        foreach ($results as $result) {
            $data['sellers'][] = array(
                ...
                'seller_changegroup' => $this->model_seller_seller->getsellergroup($result['seller_changegroup']),
    ...
    protected function getAllCustomer()
    {
        ...
        foreach ($results as $result) {
            $data['customers'][] = array(
                ...
                'name' => $result['name'],
                'email' => $result['email'],
                'customer_group' => $this->model_seller_seller->getsellergroupIdRequsetBysellerId($result['customer_id']),
                'status' => ($result['status'] ? $this->language->get('text_enabled') : $this->language->get('text_disabled')),
                'ip' => $result['ip'],
        ...
        $data['customer_groups'] = $this->model_seller_seller->getsellerGroups();
    ...
    public function seller_add_image()
    {
        ...
        if ($this->request->get['seller_image']) {
            $this->model_seller_seller->Selleraddimage($this->request->get['seller_image'], $this->request->get['seller_id']);
    ...
    public function seller_delete_image()
    {
        ...
        if ($this->request->get['seller_image']) {
            $this->model_seller_seller->Sellerdeleteimage($this->request->get['seller_id']);
    ...
    public function facebook()
    {
        ...
        $this->model_seller_seller->Sellerfacebook($this->request->get['seller_facebook'], $this->request->get['seller_id']);
    ...
    public function twitter()
    {
        ...
        $this->model_seller_seller->Sellertwitter($this->request->get['seller_twitter'], $this->request->get['seller_id']);
    ...
    public function googleplus()
    {
        ...
        $this->model_seller_seller->Sellergoogleplus($this->request->get['seller_googleplus'], $this->request->get['seller_id']);
    ...
    public function instagram()
    {
        ...
        $this->model_seller_seller->Sellerinstagram($this->request->get['seller_instagram'], $this->request->get['seller_id']);
