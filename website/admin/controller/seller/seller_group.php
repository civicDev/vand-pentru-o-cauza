...
class ControllerSellersellerGroup extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['seller_group_commission'])) {
            $data['seller_group_commission'] = $this->request->post['seller_group_commission'];
        } elseif (isset($this->request->get['seller_group_id'])) {
            $data['seller_group_commission'] = $this->model_seller_seller_group->getcommissionsellergroup($this->request->get['seller_group_id']);
        } else {
            $data['seller_group_commission'] = array();
        }
        ...
        $results = $this->model_seller_seller_group->getcommissions();
