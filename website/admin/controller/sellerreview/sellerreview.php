...
class Controllersellerreviewsellerreview extends Controller
{
    ...
    protected function getList()
    {
        ...
        $data['sort_seller_name'] = $this->url->link('sellerreview/sellerreview', 'token='.$this->session->data['token'].'&sort=r.seller_name'.$url, 'SSL');
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['seller_name'])) {
            ...
            $data['seller_name'] = $sellerreview_info['seller_name'];
        } else {
            $data['seller_name'] = '';
        }
    ...
    protected function validateForm()
    {
        ...
        if ((utf8_strlen($this->request->post['seller_name']) < 3) || (utf8_strlen($this->request->post['seller_name']) > 64)) {
