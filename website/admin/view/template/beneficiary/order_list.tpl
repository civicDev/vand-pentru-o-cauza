  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $insert; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.order_id') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'beneficiary') { ?>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.date_modified') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'o.order_settlement') { ?>
                    <a href="<?php echo $sort_order_settlement; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_order_settlement; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_order_settlement; ?>"><?php echo $column_order_settlement; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['beneficiary']; ?></td>
                  <td class="text-left"><?php echo $order['status']; ?></td>
                  <td class="text-right"><?php echo $order['total']; ?></td>
                  <td class="text-left"><?php echo $order['date_added']; ?></td>
                  <td class="text-left"><?php echo $order['date_modified']; ?></td>
                  <td class="text-center">   
					  <?php if (!empty($order['order_settlement'])) { 
                  ...
                  <td class="text-right">
					  <a href="<?php echo $order['view']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
					   <a href="<?php echo $order['invoice']; ?>" data-toggle="tooltip" title="<?php echo $button_invoice_print; ?>" class="btn btn-info"><i class="fa fa-print"></i></a>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=beneficiary/order&token=<?php echo $token; ?>';
...
//--></script> 
  <script type="text/javascript"><!--
$('input[name=\'filter_beneficiary\']').autocomplete({
	...
	'select': function(item) {
		$('input[name=\'filter_beneficiary\']').val(item['label']);
	}	
});
//--></script> 
  <script type="text/javascript"><!--
