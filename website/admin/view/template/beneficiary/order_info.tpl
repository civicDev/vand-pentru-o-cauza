...
<div id="content">
  ...
  <div class="container-fluid">
          ...
          <table class="table">
            <tr>
              ...
              <td><?php if ($beneficiary) { ?>
                <a href="<?php echo $beneficiary; ?>" target="_blank"><?php echo $firstname; ?> <?php echo $lastname; ?></a>
                <?php } else { ?>
                <?php echo $firstname; ?> <?php echo $lastname; ?>
                <?php } ?></td>
            </tr>
            <tr>
              <td><button data-toggle="tooltip" title="<?php echo $text_beneficiary_group; ?>" class="btn btn-info btn-xs"><i class="fa fa-group fa-fw"></i></button></td>
              <td><?php echo $beneficiary_group; ?></td>
            </tr>
            <tr>
          ...
          <tbody>
            ...
            <?php } ?>
             <tr>
                  ...
                  <td class="text-right"><?php echo $beneficiary_total; ?></td>
                </tr>
          </tbody>
        </table>
        <?php if ($comment) { ?>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-comment-o"></i> <?php echo $text_beneficiaryhistory; ?></h3>
      </div>
      <div class="panel-body">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#tab-beneficiaryhistory" data-toggle="tab"><?php echo $tab_beneficiaryhistory; ?></a></li>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-beneficiaryhistory">
            <div id="beneficiaryhistory"></div>
            <br />
            <fieldset>
              <legend><?php echo $text_beneficiaryhistory_add; ?></legend>
            ...
            <div class="text-right">
              <button id="button-beneficiaryhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $button_beneficiaryhistory_add; ?></button>
                         <?php
                
                  if (isset($beneficiary_order_info['settlement'])) {  ?>
				  <button id="button-cancelbeneficiarysettlementhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="fa fa-plus-circle"></i> <?php echo $button_beneficiarysettlementhistory_cancel; ?></button>
            		  <button style="display: none;" id="button-beneficiarysettlementhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> <?php echo $button_beneficiarysettlementhistory_add; ?></button>

              <?php }else{ ?>
		  <button id="button-beneficiarysettlementhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-success"><i class="fa fa-plus-circle"></i> <?php echo $button_beneficiarysettlementhistory_add; ?></button>
				  <button style="display: none;" id="button-cancelbeneficiarysettlementhistory" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger"><i class="fa fa-plus-circle"></i> <?php echo $button_beneficiarysettlementhistory_cancel; ?></button>
...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/addreward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/removereward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/addcommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/removecommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#beneficiaryhistory').delegate('.pagination a', 'click', function(e) {
	e.preventDefault();
	
	$('#beneficiaryhistory').load(this.href);
});			

$('#beneficiaryhistory').load('index.php?route=beneficiary/order/beneficiaryhistory&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&beneficiary_id=<?php echo $beneficiary_id; ?>');

$('#button-beneficiaryhistory').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
	...
	$.ajax({
		url: '<?php echo $store_url; ?>index.php?route=api/order/beneficiaryhistory&token=' + token + '&order_id=<?php echo $order_id; ?>&beneficiary_id=<?php echo $beneficiary_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
			$('#button-beneficiaryhistory').button('loading');			
		},
		complete: function() {
			$('#button-beneficiaryhistory').button('reset');	
		},
		success: function(json) {
			$('.alert').remove();
			
			if (json['error']) {
				$('#beneficiaryhistory').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			} 
			...
			if (json['success']) {
				...
				$('#beneficiaryhistory').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
$('#button-beneficiarysettlementhistory').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
    if(verifyStatusChange() == false){
      return false;
    }else{
	...
	$.ajax({
		...
		beforeSend: function() {
			$('#button-beneficiarysettlementhistory').button('loading');			
		},
		complete: function() {
			$('#button-beneficiarysettlementhistory').button('reset');
			$('#button-beneficiarysettlementhistory').hide();
			$('#button-cancelbeneficiarysettlementhistory').show();
		},
		success: function(json) {
			$('.alert').remove();
			
			if (json['error']) {
				$('#beneficiarysettlementhistory').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			} 
			...
			if (json['success']) {
				...
				$('#beneficiarysettlementhistory').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
...
$('#button-cancelbeneficiarysettlementhistory').on('click', function() {
  if(typeof verifyStatusChange == 'function'){
    if(verifyStatusChange() == false){
      return false;
    }else{
	...
	$.ajax({
		...
		beforeSend: function() {
			$('#button-cancelbeneficiarysettlementhistory').button('loading');			
		},
		complete: function() {
			$('#button-cancelbeneficiarysettlementhistory').button('reset');
			$('#button-cancelbeneficiarysettlementhistory').hide();
			$('#button-beneficiarysettlementhistory').show();
		},
		success: function(json) {
			$('.alert').remove();
			
			if (json['error']) {
				$('#cancelbeneficiarysettlementhistory').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
			} 
...
$('#beneficiaryhistory').load('index.php?route=beneficiary/order/beneficiaryhistory&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>&beneficiary_id=<?php echo $beneficiary_id; ?>');
				...
				$('#cancelbeneficiarysettlementhistory').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + ' <button type="button" class="close" data-dismiss="alert">&times;</button></div>');
