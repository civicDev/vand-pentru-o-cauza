      ...
      <div class="panel-body">
        <form class="form-horizontal">
          <ul id="order" class="nav nav-tabs nav-justified">
            <li class="disabled active"><a href="#tab-beneficiary" data-toggle="tab">1. <?php echo $tab_beneficiary; ?></a></li>
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-beneficiary">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-beneficiary"><?php echo $entry_beneficiary; ?></label>
                <div class="col-sm-10">
              ...
              <div class="text-right">
                <button type="button" id="button-beneficiary" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-arrow-right"></i> <?php echo $button_continue; ?></button>
              </div>
            </div>
            <div class="tab-pane" id="tab-cart">
              ...
              <div class="row">
                <div class="col-sm-6 text-left">
                  <button type="button" onclick="$('a[href=\'#tab-beneficiary\']').tab('show');" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo $button_back; ?></button>
                </div>
...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/cart/products&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
...
$('input[name=\'beneficiary\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			...
			success: function(json) {
				json.unshift({
					beneficiary_id: '0',
					beneficiary_group_id: '<?php echo $beneficiary_group_id; ?>',						
				...
				response($.map(json, function(item) {
					return {
						category: item['beneficiary_group'],
						label: item['name'],
						value: item['beneficiary_id'],
						beneficiary_group_id: item['beneficiary_group_id'],						
	...
	'select': function(item) {
		...
		$('#tab-beneficiary input[type=\'text\'], #tab-beneficiary input[type=\'text\'], #tab-beneficiary textarea').not('#tab-beneficiary input[name=\'beneficiary\'], #tab-beneficiary input[name=\'beneficiary_id\']').val('');
		$('#tab-beneficiary select option').removeAttr('selected');
		$('#tab-beneficiary input[type=\'checkbox\'], #tab-beneficiary input[type=\'radio\']').removeAttr('checked');
		
		$('#tab-beneficiary input[name=\'beneficiary\']').val(item['label']);
		$('#tab-beneficiary input[name=\'beneficiary_id\']').val(item['value']);
		$('#tab-beneficiary select[name=\'beneficiary_group_id\']').val(item['beneficiary_group_id']);
		$('#tab-beneficiary input[name=\'firstname\']').val(item['firstname']);
		$('#tab-beneficiary input[name=\'lastname\']').val(item['lastname']);
		$('#tab-beneficiary input[name=\'email\']').val(item['email']);
		$('#tab-beneficiary input[name=\'telephone\']').val(item['telephone']);
		$('#tab-beneficiary input[name=\'fax\']').val(item['fax']);		
				
		for (i in item.custom_field) {
			$('#tab-beneficiary select[name=\'custom_field[' + i + ']\']').val(item.custom_field[i]);
			$('#tab-beneficiary textarea[name=\'custom_field[' + i + ']\']').val(item.custom_field[i]);
			$('#tab-beneficiary input[name^=\'custom_field[' + i + ']\'][type=\'text\']').val(item.custom_field[i]);
			$('#tab-beneficiary input[name^=\'custom_field[' + i + ']\'][type=\'hidden\']').val(item.custom_field[i]);
			$('#tab-beneficiary input[name^=\'custom_field[' + i + ']\'][type=\'radio\'][value=\'' + item.custom_field[i] + '\']').prop('checked', true);	
			
			if (item.custom_field[i] instanceof Array) {
				for (j = 0; j < item.custom_field[i].length; j++) {
					$('#tab-beneficiary input[name^=\'custom_field[' + i + ']\'][type=\'checkbox\'][value=\'' + item.custom_field[i][j] + '\']').prop('checked', true);
				}
			}
		}
...
$('select[name=\'beneficiary_group_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/sale/customfield&token=<?php echo $token; ?>&beneficiary_group_id=' + this.value,
		dataType: 'json',	
		success: function(json) {
			$('.custom-field').hide();
...
$('#button-beneficiary').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/beneficiary&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		data: $('#tab-beneficiary input[type=\'text\'], #tab-beneficiary input[type=\'hidden\'], #tab-beneficiary input[type=\'radio\']:checked, #tab-beneficiary input[type=\'checkbox\']:checked, #tab-beneficiary select, #tab-beneficiary textarea'),
		dataType: 'json',
		beforeSend: function() {
			$('#button-beneficiary').button('loading');
		},
		complete: function() {
			 $('#button-beneficiary').button('reset');
		},
		success: function(json) {
			$('.alert, .text-danger').remove();
		...
		if (item['option'] != '') {
			...
			for (i = 0; i < item['option'].length; i++) {
				...
				if (option['type'] == 'datetime') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-sm-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10"><div class="input-group datetime"><input type="text" name="option[' + option['product_option_id'] + ']" value="' + option['value'] + '" placeholder="' + option['name'] + '" data-date-format="YYYY-MM-DD HH:mm" id="input-option' + option['product_option_id'] + '" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></div>';
					html += '</div>';					
				}
				...
				if (option['type'] == 'time') {
					html += '<div class="form-group' + (option['required'] ? ' required' : '') + '">';
					html += '  <label class="col-sm-2 control-label" for="input-option' + option['product_option_id'] + '">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10"><div class="input-group time"><input type="text" name="option[' + option['product_option_id'] + ']" value="' + option['value'] + '" placeholder="' + option['name'] + '" data-date-format="HH:mm" id="input-option' + option['product_option_id'] + '" class="form-control" /><span class="input-group-btn"><button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button></span></div></div>';
					html += '</div>';					
				}
			}
...
$('#button-product-add').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/cart/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher-add').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/voucher/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/cart/remove&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('select[name=\'payment_address\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/beneficiary/address&token=<?php echo $token; ?>&address_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#tab-payment select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/payment/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/payment/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/shipping/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				$.ajax({
					url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/shipping/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/shipping/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/payment/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/coupon&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/voucher&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/reward&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (order_id == 0) {
		var url = 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/order/add&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = 'index.php?route=beneficiary/order/api&token=<?php echo $token; ?>&api=api/order/edit&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + order_id;
	}
