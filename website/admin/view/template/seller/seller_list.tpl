              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right">
                    ...
                    <a href="<?php echo $seller['upgrade_sellergroup']; ?>" data-toggle="tooltip" title="" class="btn btn-success"><?php echo $button_upgrade_sellergroup; ?><?php echo $seller['seller_changegroup']['name']; ?></a>
                    ...
                    <?php } ?>
                    <?php if ($seller['seller_approved']) { ; ?>
                    <a href="<?php echo $seller['disapprove']; ?>" data-toggle="tooltip" title="<?php echo $button_disapprove; ?>" class="btn btn-danger"><i class="fa fa-thumbs-o-down"></i></a>
                    <?php } else { ?>
