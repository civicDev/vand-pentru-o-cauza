...
class ModelSellerseller extends Model
{
    public function addseller($data)
    {
        ...
        if (isset($data['seller_category'])) {
            foreach ($data['seller_category'] as $category_id) {
                $this->db->query('INSERT INTO '.DB_PREFIX."category_to_seller SET seller_id = '".(int) $seller_id."', category_id = '".(int) $category_id."'");
            }
        }
    }
    ...
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET seller_group_id = '".(int) $data['seller_group_id']."', firstname = '".$this->db->escape($data['firstname'])."', lastname = '".$this->db->escape($data['lastname'])."', email = '".$this->db->escape($data['email'])."', telephone = '".$this->db->escape($data['telephone'])."', fax = '".$this->db->escape($data['fax'])."', newsletter = '".(int) $data['newsletter']."', status = '".(int) $data['status']."', safe = '".(int) $data['safe']."' WHERE customer_id = '".(int) $seller_id."'");
    ...
    {
        $sql = "SELECT *, CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.name AS seller_group
    ...
    public function getCustomers($data = array())
    {
        ...
        if (!empty($data['filter_customer_group_id'])) {
            $implode[] = "c.seller_changegroup = '".(int) $data['filter_customer_group_id']."'";
        }
    ...
    public function Selleraddimage($seller_image, $seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET image = '".$seller_image."' WHERE customer_id='".(int) $seller_id."'");
    }
    public function Sellerdeleteimage($seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET image = '' WHERE customer_id='".(int) $seller_id."'");
    }

    public function Sellerfacebook($seller_facebook, $seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET facebook = '".$seller_facebook."' WHERE customer_id='".(int) $seller_id."'");
    }

    public function Sellertwitter($seller_twitter, $seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET twitter = '".$seller_twitter."' WHERE customer_id='".(int) $seller_id."'");
    }

    public function Sellergoogleplus($seller_googleplus, $seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET googleplus = '".$seller_googleplus."' WHERE customer_id='".(int) $seller_id."'");
    }

    public function Sellerinstagram($seller_instagram, $seller_id)
    {
        $this->db->query('UPDATE '.DB_PREFIX."customer SET instagram = '".$seller_instagram."' WHERE customer_id='".(int) $seller_id."'");
    }
    ...
    public function getsellerCategories($seller_id)
    {
        ...
        $query = $this->db->query('SELECT * FROM '.DB_PREFIX."category_to_seller WHERE seller_id = '".(int) $seller_id."'");
