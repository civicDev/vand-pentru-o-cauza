...
$_['text_next']        = 'Ce ai dori să faci în continuare?';
$_['text_next_choice'] = 'Alege dacă ai un cod de discount sau puncte de recompensă  sau doresti să estimezi costurile de livrare.';
...
$_['text_month']       = 'luna';
$_['text_year']        = 'an';
$_['text_trial']       = '%s la fiecare %s %s pentru %s plăți apoi ';
$_['text_recurring']   = '%s la fiecare %s %s';
$_['text_length']      = ' pentru %s plăți';
$_['text_until_cancelled']   	= 'până la anulare';
$_['text_recurring_item']    	              = 'Produsul';
