...
<script src="admin/view/javascript/summernote/summernote-ar-AR.js"></script>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <?php if($config_multiseller_tab_data){ ?>
            <li><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?></a></li>
            <?php } ?>
            <?php if($config_multiseller_tab_links){ ?>
            <li><a href="#tab-links" data-toggle="tab"><?php echo $tab_links; ?></a></li>
            <?php } ?>
            <?php if($config_multiseller_tab_attribute){ ?>
            <li><a href="#tab-attribute" data-toggle="tab"><?php echo $tab_attribute; ?></a></li>
            <?php } ?>
             <?php if($config_multiseller_tab_options){ ?>
            <li><a href="#tab-option" data-toggle="tab"><?php echo $tab_option; ?></a></li>
             <?php } ?>
            <?php if($config_multiseller_tab_recurring){ ?>
            <li><a href="#tab-recurring" data-toggle="tab"><?php echo $tab_recurring; ?></a></li>
             <?php } ?>
            <?php if($config_multiseller_tab_discount){ ?>
            <li><a href="#tab-discount" data-toggle="tab"><?php echo $tab_discount; ?></a></li>
             <?php } ?>
            <?php if($config_multiseller_tab_special){ ?>
            ...
            <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
             <?php } ?>
            <?php if($config_multiseller_tab_design){ ?>
            <li><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
             <?php } ?>
          </ul>
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <ul class="nav nav-tabs" id="languagetab">
                <?php foreach ($languages as $language) { ?>
                <li><a href="#languagetab<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="admin/view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
                <?php } ?>
              </ul>
              <div class="tab-content">
                <?php foreach ($languages as $language) { ?>
                <div class="tab-pane" id="languagetab<?php echo $language['language_id']; ?>">
            ...
            <div class="tab-pane" id="tab-data">
             <?php if($config_multiseller_image){ ?>
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_isbn){ ?>  
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_location){ ?>  
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <span class="help-block alert alert-danger"><?php echo $text_price_notice; ?></span>
                </div>
              </div>
              <?php } ?>
               <?php if($config_multiseller_tax_class){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_minimum_quantity){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_out_of_stock_status){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_requires_shipping){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_seo_url){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_date_available){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
               <?php if($config_multiseller_dimension){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
              <?php if($config_multiseller_status){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
              <?php if($config_multiseller_sort_order){ ?> 
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-links">
				<?php if($config_multiseller_manufacturer){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
              <?php if($config_multiseller_filters){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
              <?php if($config_multiseller_stors){ ?> 
              <div class="form-group">
              ...
              <?php } ?>
              <?php if($config_multiseller_downloads){ ?> 
              <div class="form-group">
              ...
              <?php if($config_multiseller_related_products){ ?> 
              <div class="form-group">
...
$('input[name=\'download\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=sellerproduct/download/autocomplete&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'option\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=sellerproduct/option/autocomplete&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
