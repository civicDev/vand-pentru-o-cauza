...
class ModelbeneficiaryproductOption extends Model
{
    public function addOption($data)
    {
        $this->event->trigger('pre.customer.add.option', $data);
        ...
        $this->event->trigger('post.customer.add.option', $option_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.option', $data);
        ...
        $this->event->trigger('post.customer.edit.option', $option_id);
    }

    public function deleteOption($option_id)
    {
        $this->event->trigger('pre.customer.delete.option', $option_id);
        ...
        $this->event->trigger('post.customer.delete.option', $option_id);
    }
