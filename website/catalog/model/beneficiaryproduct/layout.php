...
class ModelbeneficiaryproductLayout extends Model
{
    public function addLayout($data)
    {
        $this->event->trigger('pre.customer.add.layout', $data);
        ...
        $this->event->trigger('post.customer.add.layout', $layout_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.layout', $data);
        ...
        $this->event->trigger('post.customer.edit.layout', $layout_id);
    }

    public function deleteLayout($layout_id)
    {
        $this->event->trigger('pre.customer.delete.layout', $layout_id);
        ...
        $this->event->trigger('post.customer.delete.layout', $layout_id);
    }
