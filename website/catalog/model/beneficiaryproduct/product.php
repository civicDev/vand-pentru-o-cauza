...
class ModelbeneficiaryproductProduct extends Model
{
    public function addProduct($data)
    {
        $this->event->trigger('pre.customer.add.product', $data);
        ...
        $this->db->query('INSERT INTO '.DB_PREFIX."product_to_beneficiary SET product_id = '".$product_id."' ,beneficiary_id = '".$this->customer->getID()."'");
        ...
        $this->event->trigger('post.customer.add.product', $product_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.product', $data);
        ...
        $this->event->trigger('post.customer.edit.product', $product_id);
    }
    ...
    {
        $this->event->trigger('pre.customer.delete.product', $product_id);
        ...
        $this->event->trigger('post.customer.delete.product', $product_id);
    }
    ...
    public function isBeneficiaryProduct($product_id)
    {
        if ($product_id == 0) {
            return true;
        } else {
            $beneficiary_query = $this->db->query('SELECT * FROM '.DB_PREFIX."product_to_beneficiary WHERE beneficiary_id = '".(int) $this->customer->getId()."' AND product_id = '".(int) $product_id."'");

            return $beneficiary_query->rows;
        }
    }
    ...
    public function addProductCopy($data)
    {
        ...
        $this->db->query('INSERT INTO '.DB_PREFIX."product_to_beneficiary SET beneficiary_id = '".$this->customer->getID()."', product_id = '".$product_id."'");
