...
class ModelbeneficiaryproductRecurring extends Model
{
    public function addRecurring($data)
    {
        $this->event->trigger('pre.customer.add.recurring', $data);
        ...
        $this->event->trigger('post.customer.add.recurring', $recurring_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.recurring', $data);
        ...
        $this->event->trigger('post.customer.edit.recurring', $recurring_id);
    }
    ...
    {
        $this->event->trigger('pre.customer.delete.recurring', $recurring_id);
        ...
        $this->event->trigger('post.customer.delete.recurring', $recurring_id);
    }
