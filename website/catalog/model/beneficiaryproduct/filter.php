...
class ModelbeneficiaryproductFilter extends Model
{
    public function addFilter($data)
    {
        $this->event->trigger('pre.customer.add.filter', $data);
        ...
        $this->event->trigger('post.customer.add.filter', $filter_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.filter', $data);
        ...
        $this->event->trigger('post.customer.edit.filter', $filter_group_id);
    }

    public function deleteFilter($filter_group_id)
    {
        $this->event->trigger('pre.customer.delete.filter', $filter_group_id);
        ...
        $this->event->trigger('post.customer.delete.filter', $filter_group_id);
    }
