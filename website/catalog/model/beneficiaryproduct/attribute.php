...
class ModelbeneficiaryproductAttribute extends Model
{
    public function addAttribute($data)
    {
        $this->event->trigger('pre.customer.add.attribute', $data);
        ...
        $this->event->trigger('post.customer.add.attribute', $attribute_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.attribute', $data);
        ...
        $this->event->trigger('post.customer.edit.attribute', $attribute_id);
    }

    public function deleteAttribute($attribute_id)
    {
        $this->event->trigger('pre.customer.delete.attribute', $attribute_id);

        $this->db->query('DELETE FROM '.DB_PREFIX."attribute WHERE attribute_id = '".(int) $attribute_id."'");
        $this->db->query('DELETE FROM '.DB_PREFIX."attribute_description WHERE attribute_id = '".(int) $attribute_id."'");

        $this->event->trigger('post.customer.delete.attribute', $attribute_id);
    }
