...
class ModelorderOrder extends Model
{
    ...
    {
        $sql = '
		SELECT * FROM '.DB_PREFIX."order_sellerhistory  
    ...
    public function addOrderHistoryX($order_id, $order_status_id, $comment = '', $notify = false)
    {
        $this->db->query('INSERT INTO '.DB_PREFIX."order_sellerhistory SET order_id = '".(int) $order_id."', order_status_id = '".(int) $order_status_id."', notify = '".(int) $notify."', comment = '".$this->db->escape($comment)."', date_added = NOW()");
    }
