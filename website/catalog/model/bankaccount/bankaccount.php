...
class Modelbankaccountbankaccount extends Model
{
    ...
    {
        $this->event->trigger('pre.customer.add.bankaccount', $data);
        ...
        $this->event->trigger('post.customer.add.bankaccount', $bankaccount_id);
    ...
    {
        $this->event->trigger('pre.customer.edit.bankaccount', $data);
        ...
        $this->event->trigger('post.customer.edit.bankaccount', $bankaccount_id);
    }

    public function deletebankaccount($bankaccount_id)
    {
        $this->event->trigger('pre.customer.delete.bankaccount', $bankaccount_id);
        ...
        $this->event->trigger('post.customer.delete.bankaccount', $bankaccount_id);
    }
