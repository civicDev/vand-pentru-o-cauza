...
class Controllerbankaccountbankaccount extends Controller
{
    ...
    protected function getList()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/bankaccount/bankaccount_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/bankaccount/bankaccount_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/bankaccount/bankaccount_list.tpl', $data));
        }
    }
    ...
    protected function getListForProfile()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/bankaccount/bankaccountforprofile_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/bankaccount/bankaccountforprofile_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/bankaccount/bankaccountforprofile_list.tpl', $data));
        }
    }
    protected function getForm()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/bankaccount/bankaccount_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/bankaccount/bankaccount_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/bankaccount/bankaccount_form.tpl', $data));
        }
    }
