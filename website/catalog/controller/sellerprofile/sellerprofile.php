...
class Controllersellerprofilesellerprofile extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['seller_group'])) {
            ...
            $results = $this->model_sellerprofile_sellerprofile->getsellerGroup($seller_info['seller_group_id']);
            foreach ($results as $result) {
                $data['seller_group_info'][] = array(
        ...
        if (isset($this->request->post['seller_group_subscription_price'])) {
            ...
            $data['seller_group_subscription_price'] = $this->currency->format($seller_info['subscription_price']);
        } else {
        ...
        foreach ($results as $result) {
            $data['seller_groups'][] = array(
                ...
                'seller_categories' => $this->model_sellerproduct_category->getCategories($result['seller_group_id']),
                'name' => $result['name'],
                ...
                'seller_group_commission' =>$result['commission_name'],
                'categories' => $this->model_sellerproduct_product->getsellerCategories($this->customer->getID()),
                'seller_group_commission_rate' =>  ($result['type'] == "F") ? $this->currency->format($result['rate']) : $result['rate']."%" ,
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_form.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_form.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_form.tpl', $data));
        }
    }
    ...
    public function approve()
    {
        ...
        if ($sellers && $this->validateApprove()) {
            $this->model_sellerprofile_sellerprofile->approve($this->request->get['seller_id']);
            ...
            $this->response->redirect($this->url->link('sellerprofile/sellerprofile', $url, 'SSL'));
        }
    ...
    public function badge()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_badge.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_badge.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_badge.tpl', $data));
        }
    }
    ...
    public function sellerproduct()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_sellerproduct.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_sellerproduct.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_sellerproduct.tpl', $data));
        }
    }
    ...
    public function history()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_history.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_history.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_history.tpl', $data));
        }
    }
    ...
    public function transaction()
    {
        ...
        $data['balance'] = $this->currency->format($this->model_sellerprofile_sellerprofile->getTransactionTotal($this->request->get['seller_id']));
        ...
        if ($seller_info) {
            ...
            'total' => ($result['type'] == 'P' ? $this->currency->format($balance - ($balance * $result['rate'] / 100)) : $this->currency->format($balance - $result['rate'])),
                'seller_commission' => ($result['type'] == 'F' ? $this->currency->format($result['rate'] * -1) : intval($result['rate'] * -1).'% '),
                'seller_subscription_price' => $this->currency->format($this->currency->format($seller_info['subscription_price'] * (-1))),
            );
            }
        } else {
            $data['seller_group_info'][] = array(
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_transaction.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_transaction.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_transaction.tpl', $data));
        }
    }
    ...
    public function request_membership()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/sellerprofile/sellerprofile_request_membership.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/sellerprofile/sellerprofile_request_membership.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/sellerprofile/sellerprofile_request_membership.tpl', $data));
        }
    }
    ...
    public function seller_add_image()
    {
        $this->load->language('sellerprofile/sellerprofile');
        ...
        if ($this->request->get['seller_image']) {
            $this->model_sellerprofile_sellerprofile->Selleraddimage($this->request->get['seller_image']);
    ...
    public function facebook()
    {
        ...
        $this->model_sellerprofile_sellerprofile->Selleraddfacebook($this->request->get['seller_facebook']);
    ...
    public function twitter()
    {
        ...
        $this->model_sellerprofile_sellerprofile->Selleraddtwitter($this->request->get['seller_twitter']);
    ...
    public function googleplus()
    {
        ...
        $this->model_sellerprofile_sellerprofile->Selleraddgoogleplus($this->request->get['seller_googleplus']);
    ...
    public function instagram()
    {
        ...
        $this->model_sellerprofile_sellerprofile->Selleraddinstagram($this->request->get['seller_instagram']);
