...
class Controllersellerseller extends Controller
{
    public function index()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/seller/seller_list.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/seller/seller_list.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/seller/seller_list.tpl', $data));
        }
    }
    ...
    public function info()
    {
        ...
        if ($seller_info) {
            ...
            if ($seller_info['image']) {
                $data['seller_image'] = $this->model_tool_image->resize($seller_info['image'], 90, 90);
            } else {
                $data['seller_image'] = $this->model_tool_image->resize('placeholder.png', 90, 90);
            }
            ...
            $product_total = $this->model_seller_seller->getTotalProducts($filter_data);
            ...
            if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/seller/seller_info.tpl')) {
                $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/seller/seller_info.tpl', $data));
            } else {
                $this->response->setOutput($this->load->view('default/template/seller/seller_info.tpl', $data));
            }
        } else {
            $url = '';
    ...
    public function sellerreview()
    {
        ...
        if (file_exists(DIR_TEMPLATE.$this->config->get('config_template').'/template/seller/seller_review.tpl')) {
            $this->response->setOutput($this->load->view($this->config->get('config_template').'/template/seller/seller_review.tpl', $data));
        } else {
            $this->response->setOutput($this->load->view('default/template/seller/seller_review.tpl', $data));
        }
    }
